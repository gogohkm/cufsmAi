...
m4a = uimenu(m4,'Label','Main Pre-processor',...
                'Callback',[...
                'commandbar_cb(8);']);
m4b = uimenu(m4,'Label','CLASSIC C/Z Template',...
                'Callback',[...
                'commandbar_cb(21);']);
m4b2 = uimenu(m4,'Label','GENERAL Template',...
                'Callback',[...
                'commandbar_cb(27);']);
...
p4a = uipushtool(t,'TooltipString','Main Pre-processor',...
                ...
                p4a.CData = icon;
p4b = uipushtool(t,'TooltipString','CLASSIC C/Z Template',...
                'ClickedCallback',[...
                'commandbar_cb(21);']);
                [img,map] = imread('template_legacy.png','BackgroundColor',[0.94 0.94 0.94]);
                icon = img;%ind2rgb(img,map);
                p4b.CData = icon;
p4b2 = uipushtool(t,'TooltipString','GENERAL Template',...
                'ClickedCallback',[...
                'commandbar_cb(27);']);
